  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok && data.token) {
        ...
        // Make sure these state variables are defined elsewhere in your component
        // or remove/replace with other notification method
            ...
            <div className="flex items-start">
              <div className="ml-3">
                ...
                <div className="mt-1 text-sm text-yellow-700">
                  <p>The backend server appears to be offline or unavailable. Make sure the server is running on port 3001 before attempting to log in.</p>
                  <div className="mt-2">
